...
import jasmin.utils.java_cup.runtime.symbol;
...
class CUP$actions {
  ...
  public final symbol CUP$do_action(
    ...
    throws Exception
    {
      ...
      switch (CUP$act_num)
        {
          ...
          case 64: // empty ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*empty*/27);
          ...
          case 63: // label_id ::= ID
            {
              CUP$result = new jasmin.utils.java_cup.runtime.str_token(/*label_id*/30);
               ((jasmin.utils.java_cup.runtime.str_token)CUP$result).str_val = (/*the_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val;
            }
          return CUP$result;
          ...
          case 62: // symbol_id ::= ID
            {
              CUP$result = new jasmin.utils.java_cup.runtime.str_token(/*symbol_id*/29);
               ((jasmin.utils.java_cup.runtime.str_token)CUP$result).str_val = (/*the_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val;
            }
          return CUP$result;
          ...
          case 61: // nt_id ::= ID
            {
              CUP$result = new jasmin.utils.java_cup.runtime.str_token(/*nt_id*/28);
               ((jasmin.utils.java_cup.runtime.str_token)CUP$result).str_val = (/*the_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val;
            }
          return CUP$result;
          ...
          case 60: // new_non_term_id ::= ID
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*new_non_term_id*/24);

	  /* see if this non terminal has been declared before */
	  if (symbols.get((/*non_term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val) != null)
	    {
	      /* issue a message */
	      lexer.emit_error( "Symbol \"" + (/*non_term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val +
		...
		new non_terminal((/*non_term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val, multipart_name);

	      /* put it in the non_terms table */
	      non_terms.put((/*non_term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val, this_nt);

	      /* build a production_part and put it in the symbols table */
	      symbols.put((/*non_term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val, new symbol_part(this_nt));
	    }
          ...
          case 59: // new_term_id ::= ID
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*new_term_id*/23);

	  /* see if this terminal has been declared before */
	  if (symbols.get((/*term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val) != null)
	    {
	      /* issue a message */
	      lexer.emit_error("Symbol \"" + (/*term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val +
			   "\" has already been declared");
	    }
	  else
	    {
	      /* build a production_part and put it in the table */
	      symbols.put((/*term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val,
	        new symbol_part(new terminal((/*term_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val, multipart_name)));
	    }
          ...
          case 58: // type_id ::= multipart_id
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*type_id*/17);
          ...
          case 57: // import_id ::= multipart_id
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*import_id*/12);
          ...
          case 55: // multipart_id ::= ID
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*multipart_id*/10);
               append_multipart((/*an_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val);
            }
          return CUP$result;
          ...
          case 54: // multipart_id ::= multipart_id DOT ID
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*multipart_id*/10);
               append_multipart((/*another_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val);
            }
          return CUP$result;
          ...
          case 53: // opt_label ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.str_token(/*opt_label*/31);
               ((jasmin.utils.java_cup.runtime.str_token)CUP$result).str_val = null;
            }
          return CUP$result;
          ...
          case 52: // opt_label ::= COLON label_id
            {
              CUP$result = new jasmin.utils.java_cup.runtime.str_token(/*opt_label*/31);
               ((jasmin.utils.java_cup.runtime.str_token)CUP$result).str_val = (/*labid*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val;
            }
          return CUP$result;
          ...
          case 51: // prod_part ::= CODE_STRING
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*prod_part*/22);

	  /* add a new production part */
	  add_rhs_part(new action_part((/*code_str*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val));
	  ...
	  production_part symb = (production_part)symbols.get((/*symid*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-1)).str_val);

	  /* if that fails, symbol is undeclared */
	  if (symb == null)
	    {
	      if (lexer.error_count == 0)
	        lexer.emit_error("Symbol \"" + (/*symid*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-1)).str_val +
			       "\" has not been declared");
	    }
	  else
	    {
	      /* add a labeled production part */
	      add_rhs_part(add_lab(symb, (/*labid*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val));
	    }
          ...
          case 49: // prod_part_list ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*prod_part_list*/21);
          ...
          case 47: // rhs ::= prod_part_list
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*rhs*/26);
	  ...
	  new_rhs();
          ...
          case 46: // rhs_list ::= rhs
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*rhs_list*/25);
          ...
          case 44: // production ::= error NT$9 SEMI
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*production*/20);
          ...
          case 43: // NT$9 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$9*/41);
          ...
          case 41: // NT$8 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$8*/40);

	  /* lookup the lhs nt */
	  lhs_nt = (non_terminal)non_terms.get((/*lhs_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val);

          /* if it wasn't declared, emit a message */
	  if (lhs_nt == null)
	    {
	      if (lexer.error_count == 0)
	        lexer.emit_error("LHS non terminal \"" + (/*lhs_id*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val +
			       "\" has not been declared");
	    }
	  ...
	  new_rhs();
          ...
          case 40: // production_list ::= production
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*production_list*/9);
          ...
          case 38: // start_spec ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*start_spec*/8);
          ...
          case 36: // NT$7 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$7*/39);

	  /* verify that the name has been declared as a non terminal */
	  non_terminal nt = (non_terminal)non_terms.get((/*start_name*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val);
	  if (nt == null)
	    {
	      lexer.emit_error( "Start non terminal \"" + (/*start_name*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-0)).str_val +
	  		         "\" has not been declared");
	    }
          else
	    {
          ...
          case 35: // non_term_name_list ::= new_non_term_id
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*non_term_name_list*/19);
          ...
          case 33: // term_name_list ::= new_term_id
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*term_name_list*/18);
          ...
          case 31: // symbol ::= NON TERMINAL error NT$6 SEMI
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*symbol*/15);
          ...
          case 30: // NT$6 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$6*/38);
	  ...
	  multipart_name = new String();
          ...
          case 28: // NT$5 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$5*/37);
	  ...
	  multipart_name = new String();
          ...
          case 26: // NT$4 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$4*/36);
	  ...
	  multipart_name = new String();
          ...
          case 24: // NT$3 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$3*/35);
	  ...
	  multipart_name = new String();
          ...
          case 23: // symbol_list ::= symbol
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*symbol_list*/7);
          ...
          case 21: // debug_grammar ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*debug_grammar*/16);
	  ...
	  /* save the procedure name */
          ...
          case 19: // scan_code ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*scan_code*/14);
	  ...
	  /* save the user code */
	  emit.scan_code = (/*user_code*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-1)).str_val;
          ...
          case 17: // init_code ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*init_code*/13);
	  ...
	  /* save the user code */
	  emit.init_code = (/*user_code*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-1)).str_val;
          ...
          case 15: // parser_code_part ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*parser_code_part*/6);
	  ...
	  emit.parser_code = (/*user_code*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-1)).str_val;
          ...
          case 13: // action_code_part ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*action_code_part*/5);
	  ...
	  /* save the user included code string */
	  emit.action_code = (/*user_code*/(jasmin.utils.java_cup.runtime.str_token)CUP$stack.elementAt(CUP$top-1)).str_val;
          ...
          case 11: // code_part ::= action_code_part parser_code_part
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*code_part*/4);
          ...
          case 10: // import_spec ::= IMPORT import_id NT$2 SEMI
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*import_spec*/11);
          ...
          case 9: // NT$2 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$2*/34);
	  ...
	  multipart_name = new String();
          ...
          case 8: // import_list ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*import_list*/3);
          ...
          case 6: // package_spec ::= empty
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*package_spec*/2);
          ...
          case 4: // NT$1 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$1*/33);
	  ...
	  multipart_name = new String();
          ...
          case 3: // spec ::= error symbol_list start_spec production_list
            {
              CUP$result = new jasmin.utils.java_cup.runtime.symbol(/*spec*/1);
          ...
          case 1: // NT$0 ::=
            {
              CUP$result = new jasmin.utils.java_cup.runtime.token(/*NT$0*/32);
