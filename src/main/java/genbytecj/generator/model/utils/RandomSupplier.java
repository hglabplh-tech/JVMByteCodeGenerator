...
import genbytecj.generator.model.types.base.ArrayType;
...
import static genbytecj.generator.model.types.base.ArrayType.MIN_ARRAY_DIM_LENGTH;
import static genbytecj.generator.model.types.base.MetaType.Kind.BYTE;
import static genbytecj.generator.model.types.base.MetaType.Kind.SHORT;
import static genbytecj.generator.model.types.base.VoidType.VOID;
import static genbytecj.generator.model.utils.ErrorUtils.shouldNotReachHere;
...
public class RandomSupplier {
    ...
    public MetaType<?> arrayType(int dim) {
        return randomizer
                .oneOf(TypeCache.CACHE.types().filter(t -> t.kind() != MetaType.Kind.VOID))
