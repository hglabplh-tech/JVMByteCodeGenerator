...
import static genbytecj.generator.model.types.base.PrimitiveType.*;
import static genbytecj.generator.model.utils.Operator.*;
...
class MathGenerator extends MethodCaller {
    ...
    public void generateOperatorStatement(MethodLogger<?> method, int maxOperations, Operator.OpStatKind opStatKind) {
    ...
    public String srcGenerateOperatorStatement(MethodLogger<?> method, int maxOperations, Operator.OpStatKind opStatKind) {
        return srcGenerateOperatorStatement(method, maxOperations, opStatKind, false);
    }

    public String srcGenerateOperatorStatement(MethodLogger<?> method, int maxOperations, Operator.OpStatKind opStatKind, boolean useNoVars) {
    ...
    public void setLocalVarToOperatorStatement(MethodLogger<?> method, int maxOperations, Operator.OpStatKind opStatKind) {
    ...
    public String srcSetLocalVarToOperatorStatement(MethodLogger<?> method, int maxOperations, Operator.OpStatKind opStatKind) {
    ...
    public void setFieldToOperatorStatement(MethodLogger<?> method, int maxOperations, Operator.OpStatKind opStatKind) {
    ...
    public String srcSetFieldToOperatorStatement(MethodLogger<?> method, int maxOperations, Operator.OpStatKind opStatKind) {
    ...
    private FieldVarLogger<?> fetchLocalAssignVarForOperandStatement(MethodLogger<?> method, Operator.OpStatKind opStatKind) {
    ...
    private FieldVarLogger<?> fetchGlobalAssignVarForOperandStatement(MethodLogger<?> method, Operator.OpStatKind opStatKind) {
        PrimitiveType<?> type = fetchAssignVarTypeForOperandStatement(opStatKind);
        return this.getClazzLogger().getNonFinalFieldOfTypeUsableInMethod(method, type);
    }

    private PrimitiveType<?> fetchAssignVarTypeForOperandStatement(Operator.OpStatKind opStatKind) {
    ...
    private StringBuilder combinedWithLogicalStatement(Operator.OpStatKind bitAndOrArithmetic, MethodLogger<?> method, int numberOfOperands, boolean useNoVars) {
        StringBuilder src = new StringBuilder();
    ...
    private StringBuilder srcGenerateOperatorStatementOfKind(MethodLogger<?> method, int nbrOfOperands, Operator.OpStatKind opStatKind, boolean useNoVars) {
        Operator operator = null;
        ...
        for (int i = 0; i < nbrOfOperands; i++) {
            ...
            if (f == null || (operator == DIV || operator == MOD) && incDecrementOperands.contains(f)) {
                ...
                if (type == BOOLEAN) {
                    operand = new JavassistResolver().resolve(getClazzLogger().valueOf(type, method));
